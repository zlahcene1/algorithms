...
public:
    c4081(std::string chipName, std::string chipType) : crntChipName{chipName},
    ...
    nts::Tristate compute(std::size_t pin) override {
        if (pin == 3)
        {
            if (otherPin[0].giveValueOtherPin() == nts::TRUE && otherPin[1].giveValueOtherPin() == nts::TRUE)
                return (nts::TRUE);
            if (otherPin[0].giveValueOtherPin() == nts::FALSE && otherPin[1].giveValueOtherPin() == nts::UNDEFINED)
                return (nts::FALSE);
            if (otherPin[0].giveValueOtherPin() == nts::UNDEFINED && otherPin[1].giveValueOtherPin() == nts::FALSE)
                return (nts::FALSE);
        ...
        if (pin == 4)
        {
            if (otherPin[4].giveValueOtherPin() == nts::TRUE && otherPin[5].giveValueOtherPin() == nts::TRUE)
                return (nts::TRUE);
            if (otherPin[4].giveValueOtherPin() == nts::FALSE && otherPin[5].giveValueOtherPin() == nts::UNDEFINED)
                return (nts::FALSE);
            if (otherPin[4].giveValueOtherPin() == nts::UNDEFINED && otherPin[5].giveValueOtherPin() == nts::FALSE)
                return (nts::FALSE);
        ...
        if (pin == 10)
        {
            if (otherPin[6].giveValueOtherPin() == nts::TRUE && otherPin[7].giveValueOtherPin() == nts::TRUE)
                return (nts::TRUE);
            if (otherPin[6].giveValueOtherPin() == nts::FALSE && otherPin[7].giveValueOtherPin() == nts::UNDEFINED)
                return (nts::FALSE);
            if (otherPin[6].giveValueOtherPin() == nts::UNDEFINED && otherPin[7].giveValueOtherPin() == nts::FALSE)
                return (nts::FALSE);
        ...
        if (pin == 11)
        {
            if (otherPin[10].giveValueOtherPin() == nts::TRUE && otherPin[11].giveValueOtherPin() == nts::TRUE)
                return (nts::TRUE);
            if (otherPin[10].giveValueOtherPin() == nts::FALSE && otherPin[11].giveValueOtherPin() == nts::UNDEFINED)
                return (nts::FALSE);
            if (otherPin[10].giveValueOtherPin() == nts::UNDEFINED && otherPin[11].giveValueOtherPin() == nts::FALSE)
                return (nts::FALSE);
